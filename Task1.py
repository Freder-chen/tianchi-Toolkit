...
OUT_PERSON_PATH = 'splits/train_A/split_person_train/'
OUT_VEHICLE_PATH = 'splits/train_A/split_vehicle_train/'
COCO_FORMAT_JSON_PATH = 'splits/train_A/coco_format_json'
# test A
# IMAGE_ROOT = 'dataset/test_A'
